...
# Training Data Location
#feats_tr="/work/local/sumu/mop/exp/std_1k/train.scp"
#feats_cv="/work/local/sumu/mop/exp/std_1k/cv.scp"
#labels_tr="/work/local/sumu/ark-prepare/ark-std-84dim/cut.pdf"
#labels_cv="/work/local/sumu/ark-prepare/ark-std-84dim/dev.pdf"
#
# NN Parameter
#mlp_init="/work/local/sumu/mop/exp/std_1k/nnet_5.dbn_dnn.init"
#feature_transform="/work/local/sumu/mop/exp/std_1k/final.feature_transform"
...
for iter in $(seq -w $max_iters); do
  ...
  $train_tool --num-updates=$freq_update --num-threads=$num_thread --cross-validate=false --learn-rate=$learn_rate --bunchsize=$minibatch_size \
              --cachesize=$randomizer_size --feature-transform=$feature_transform \
